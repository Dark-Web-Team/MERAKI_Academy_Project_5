  ...
  return (
    <div className="footer">
      <div className="footerch">
        ...
        <p style={{ fontFamily: '"Mukta", sans-serif' }} id="numper_email">
          055450500
        </p>
        <p style={{ fontFamily: '"Mukta", sans-serif' }} id="numper_email">
          Dark-Web@Dark-Web.com
        </p>
      </div>
      <div className="footerch">
        <p style={{ fontFamily: '"Mukta", sans-serif' }}>Our Services</p>
        <p style={{ fontFamily: '"Mukta", sans-serif' }} id="numper_email">
